    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-xs md:text-sm mt-0.5">NFPA 211 / CSIA compliant reports</p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        {[
          ...
          { label: "Deficiencies", value: deficient, icon: AlertCircle, color: "text-red-700 bg-red-50" },
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="divide-y divide-gray-50">
            {inspections.map((insp) => (
              <Link
                ...
                className="flex items-start justify-between px-4 md:px-6 py-4 hover:bg-amber-50/50 transition-colors gap-3"
              >
        ...
        {drafts > 0 && (
          <div className="px-4 py-3 bg-amber-50 border-t border-amber-100 rounded-b-xl">
            <p className="text-xs text-amber-700">📋 {drafts} draft inspection{drafts > 1 ? "s" : ""} in progress.</p>
          </div>
        )}
      </div>
    </div>
